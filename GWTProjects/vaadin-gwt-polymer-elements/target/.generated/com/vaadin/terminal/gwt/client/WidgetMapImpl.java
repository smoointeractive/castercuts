...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.Accordion" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VAccordion.class); return com.vaadin.terminal.gwt.client.ui.VAccordion.class;}
    ...
    else if ( fullyQualifiedName == "com.smoointeractive.test.ColorPicker" ) { ensureInstantiator(com.smoointeractive.test.gwt.client.ui.VColorPicker.class); return com.smoointeractive.test.gwt.client.ui.VColorPicker.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VAccordion.class) {instmap.put(com.vaadin.terminal.gwt.client.ui.VAccordion.class, new WidgetInstantiator() {
...
);} else if( classType == com.smoointeractive.test.gwt.client.ui.VColorPicker.class) {instmap.put(com.smoointeractive.test.gwt.client.ui.VColorPicker.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.smoointeractive.test.gwt.client.ui.VColorPicker.class );
  }
  }
