...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.smoointeractive.test.ColorPicker" ) { ensureInstantiator(com.smoointeractive.test.gwt.client.ui.VColorPicker.class); return com.smoointeractive.test.gwt.client.ui.VColorPicker.class;}
  ...
  if( classType == com.smoointeractive.test.gwt.client.ui.VColorPicker.class) {instmap.put(com.smoointeractive.test.gwt.client.ui.VColorPicker.class, new WidgetInstantiator() {
